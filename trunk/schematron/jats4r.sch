...
<sch:schema xmlns:xsl="http://www.w3.org/1991/XSL/Transform"
    xmlns:sch="http://purl.oclc.org/dsdl/schematron" schemaVersion="Alpha 20180228"
    xmlns:xf="http://xmlfirst.com" queryBinding="xslt2">
    ...
    <sch:ns uri="http://xmlfirst.com" prefix="xf"/>
    ...
    <sch:pattern id="gen">
        ...
        <!-- <sch:pattern>
        <sch:rule id="gen-04a" context="/processing-instruction('xml-model')">
            <sch:assert diagnostics="diag.gen-04a" test="contains(.,'href=')">No href
                pseudo-attribute</sch:assert>
        </sch:rule> -->
